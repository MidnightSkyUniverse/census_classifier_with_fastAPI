...
from functions import  compute_model_metrics, train_RandomForest_model, inference, save_model, load_model, data_encoder
import process_data
...
def go():
    ...
    slice_scores = yaml.safe_load(open("params.yaml"))["metrics"]['slice_scores']
